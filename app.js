...
const initializer = () => {
    ...
    // create function for font names
    fontList.map((value) => {
    ...
    // options that requires value parameter (e.g VideoColorSpace, fonts)
    ...
    className.forEach((button) => {
        button.addEventListener("click", () =>  {
            ...
            if (needsRemoval) {
                ...
                // If currently clicked button is alraedy active
